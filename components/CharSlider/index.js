...
export default function CharSlider() {
  ...
  return (
    <div className={styles.container}>
        ...
        <Image className={styles.arrow} src={Arrow} width={50} height={50} onClick={() => setNumber(number - 1)}/>
        ...
        <Image className={styles.arrow} src={ArrowRight} width={50} height={50} onClick={() => setNumber(number + 1)}/>
    </div>
  )
}
